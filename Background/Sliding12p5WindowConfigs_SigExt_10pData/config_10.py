...
backgroundScriptCfg = {
  ...
  # Setup
  'inputWSFile':'/eos/user/a/atsatsos/ULFlashGG_Files/NewReleaseFiles/JUN2024FITWS_SIGEXT/10pData_12p5pSlidingWindow/ws/all2018data_10GeV.root', # location of 'allData.root' file
