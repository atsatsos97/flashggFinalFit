...
backgroundScriptCfg = {
  ...
  # Setup
  'inputWSFile':'/eos/user/a/atsatsos/ULFlashGG_Files/NewReleaseFiles/JUL2024FITWS_SIGEXT/AllData_12p5SlidingWindow/ws/10GeV_all2018data.root', # location of 'allData.root' file
