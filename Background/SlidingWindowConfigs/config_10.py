...
backgroundScriptCfg = {
  ...
  # Setup
  'inputWSFile':'/eos/user/a/atsatsos/ULFlashGG_Files/NewReleaseFiles/APR2024FITWS/Apr2024_NN0.78_10pData5pWindow/10GeV/ws/all2018data_v1.root', # location of 'allData.root' file
