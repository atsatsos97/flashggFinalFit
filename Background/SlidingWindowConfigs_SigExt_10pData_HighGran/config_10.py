...
backgroundScriptCfg = {
  ...
  # Setup
  'inputWSFile':'/eos/user/a/atsatsos/ULFlashGG_Files/NewReleaseFiles/JUL2024FITWS_SIGEXT/10pData_SlidingWindow_HighGran/ws/10GeV_all2018data.root', # location of 'allData.root' file
