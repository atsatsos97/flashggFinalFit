...
backgroundScriptCfg = {
  ...
  # Setup
  'inputWSFile':'/eos/user/a/atsatsos/ULFlashGG_Files/NewReleaseFiles/JUN2024FITWS_SIGEXT/AllData_10pSlidingWindow/ws/all2018data_10GeV.root', # location of 'allData.root' file
