...
backgroundScriptCfg = {
  ...
  # Setup
  'inputWSFile':'/eos/user/a/atsatsos/ULFlashGG_Files/NewReleaseFiles/SEP2024FITWS_SIGEXT/10pData_SubRanges/ws/Window4_v2_all2018data.root', # location of 'allData.root' file
  ...
  'mass':'Window4_v2', # Mass point for sliding window
