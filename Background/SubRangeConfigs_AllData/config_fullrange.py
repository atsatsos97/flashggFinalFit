...
backgroundScriptCfg = {
  ...
  # Setup
  'inputWSFile':'/eos/user/a/atsatsos/ULFlashGG_Files/NewReleaseFiles/SEP2024FITWS_SIGEXT/AllData_SubRanges/ws/FullRange_all2018data.root', # location of 'allData.root' file
