...
backgroundScriptCfg = {
  ...
  # Setup
  'inputWSFile':'/eos/user/a/atsatsos/ULFlashGG_Files/NewReleaseFiles/SEP2024FITWS_SIGEXT/AllData_SubRanges/ws/Window2and3_v1_all2018data.root', # location of 'allData.root' file
  ...
  'mass':'Window2and3_v1', # Mass point for sliding window
