...
combine -m {mass} -M GoodnessOfFit --algorithm KS {base_path}/sliding_{mass}GeV_cat1.txt --freezeParameters MH  --saveWorkspace --X-rtd MINIMIZER_MaxCalls=99999999 --X-rtd MINIMIZER_optimizeConst=1 --rMin -7 --rMax 7 --cminDefaultMinimizerStrategy 1 --cminDefaultMinimizerTolerance 1 --X-rtd MINIMIZER_freezeDisassociatedParams -t 1000 --toysFrequentist --saveToys -n Toys 

combine -m {mass} -M GoodnessOfFit --algorithm KS {base_path}/sliding_{mass}GeV_cat1.txt --freezeParameters MH  --saveWorkspace --X-rtd MINIMIZER_MaxCalls=99999999 --X-rtd MINIMIZER_optimizeConst=1 --rMin -7 --rMax 7 --cminDefaultMinimizerStrategy 1 --cminDefaultMinimizerTolerance 1 --X-rtd MINIMIZER_freezeDisassociatedParams 
"""
...
transfer_input_files = {executable_path},{base_path}/sliding_{mass}GeV_cat1.txt
...
for mass in range(10,71):
    mass_path = os.path.join(exe_path, "cat1/")
