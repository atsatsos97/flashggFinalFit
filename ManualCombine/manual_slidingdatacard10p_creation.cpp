...
void manual_slidingdatacard10p_creation(){
  for (int mass=10; mass<71; mass++){
    ...
    for(int cat=0; cat<4; cat++){
      ...
      cat_n = Form("_%i",cat);
      char inputShape[200];
      sprintf(inputShape,"datacards_10psliding/sliding_"+mass_s+cat_s+".txt");
      ...
      newcardShape << Form("shapes     data_obs "+cat_s+" ../ws_10psliding/CMS-HGG_"+mass_s+"multipdf_UntaggedTag"+cat_n+".root multipdf:roohist_data_mass_UntaggedTag"+cat_n+"\n");
