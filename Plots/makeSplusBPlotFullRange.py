...
# Save canvas
canv.Update()
canv.SaveAs("/eos/user/a/atsatsos/www/SEP2024FinalFits/AllData_SubRange_Envelope/2_bkgModeling_CWR.C")
canv.SaveAs("/eos/user/a/atsatsos/www/SEP2024FinalFits/AllData_SubRange_Envelope/2_bkgModeling_CWR.png")
canv.SaveAs("/eos/user/a/atsatsos/www/SEP2024FinalFits/AllData_SubRange_Envelope/2_bkgModeling_CWR.pdf")
