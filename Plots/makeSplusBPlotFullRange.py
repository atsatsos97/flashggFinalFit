...
line1 = ROOT.TLine(14.5, 0.0, 14.5, 2750.0)
line1.SetLineColor(kRed-7)
line1.SetLineStyle(7)
line1.SetLineWidth(1)
line1.Draw("same")
line2 = ROOT.TLine(40.0, 0.0, 40.0, 2750.0)
line2.SetLineColor(kRed-7)
line2.SetLineStyle(7)
line2.SetLineWidth(1)
line2.Draw("same")
line3 = ROOT.TLine(54.5, 0.0, 54.5, 2750.0)
...
lat0.DrawLatex(0.75,0.92,"54.4 fb^{-1} (13 TeV)")
...
h_axes_ratio.GetYaxis().SetNdivisions(504,False)
...
line1r.SetLineWidth(1)
line1r.Draw("same")
line2r = ROOT.TLine(40.0, -250.0, 40.0, 500.0)
line2r.SetLineColor(kRed-7)
line2r.SetLineStyle(7)
line2r.SetLineWidth(1)
line2r.Draw("same")
line3r = ROOT.TLine(54.5, -250.0, 54.5, 500.0)
line3r.SetLineColor(kRed-7)
line3r.SetLineStyle(7)
line3r.SetLineWidth(1)
line3r.Draw("same")
...
# Save canvas
canv.Update()
canv.SaveAs("/eos/user/a/atsatsos/www/SEP2024FinalFits/AllData_SubRange_Envelope/2_bkgModeling_FINAL.C")
canv.SaveAs("/eos/user/a/atsatsos/www/SEP2024FinalFits/AllData_SubRange_Envelope/2_bkgModeling_FINAL.png")
canv.SaveAs("/eos/user/a/atsatsos/www/SEP2024FinalFits/AllData_SubRange_Envelope/2_bkgModeling_FINAL.pdf")
